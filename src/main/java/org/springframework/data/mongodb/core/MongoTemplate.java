...
public class MongoTemplate implements MongoOperations, ApplicationContextAware, IndexOperationsProvider {
	...
	public void setTenantAwareQueryOperations(TenantAwareQueryMapper tenantAwareQueryMapper) {
		this.queryOperations = new QueryOperations(tenantAwareQueryMapper, updateMapper, operations, propertyOperations,
				mongoDbFactory);
	}
		...
		public FindIterable<Document> prepare(FindIterable<Document> iterable) {
			...
			try {
				...
				if (meta.hasValues()) {
					...
					for (CursorOption option : meta.getFlags()) {
